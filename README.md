![](https://github.com/isabellabenabaye/ggplot2-reference/blob/master/ggplot2-theme-elements-reference.png?raw=true)
...
I also made a PDF version so that it's easy to copy-paste the code. Feel free to download it or the PNG version from this repository or my [website](https://isabella-b.com/blog/ggplot2-theme-elements-reference).
